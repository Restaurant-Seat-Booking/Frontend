    ...
    return (
        <>
            ...
            <div class="container marketing">
                ...
                <div class="row">
                    <div class="col-lg-4">
                    <img src="./images/res1.jpg" class="bd-placeholder-img rounded-circle" width="140" height="140" alt="Slide 1"  />
                ...
                <div class="row featurette">
                    ...
                    <div class="col-md-5">
                    <img src="./images/res1.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="300" alt="Slide 1"  />
